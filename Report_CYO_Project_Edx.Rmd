...
##Training The Model
Following the PCA, different models will be trained given the training dataset with the 80% and 90% variance principal components.

The following code will perform the training of 11 different models and print out the accuracies for the 80% variance set:
...
The following code will perform the training of 11 different models and report the accuracies for the 90% variance set:
